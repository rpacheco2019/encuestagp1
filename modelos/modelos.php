...
function save_encuesta($nombre,$evento,$fecha,$lugar,$type,$p1,$p2,$p3,$p4,$p5){
	try {
        ...
        $statement = $conn->prepare("INSERT INTO planner (nombre,evento,fecha,lugar,tipo,p1,p2,p3,p4,p5) VALUES('$nombre','$evento','$fecha','$lugar','$type','$p1','$p2','$p3','$p4','$p5')");
